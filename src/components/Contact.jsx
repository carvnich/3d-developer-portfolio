    ...
    const handleSubmit = (e) => {
        ...
        emailjs
            ...
            .then(
                () => {
                    setLoading(false);
                    showModal("success", "Thank you! I will get back to you as soon as possible.");
            ...
            <div className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden`}>
                <motion.div variants={slideIn("left", "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
                        ...
                        <button type="submit" className="bg-tertiary hover:bg-quaternary py-3 px-8 rounded-xl outline-none w-full text-white font-bold shadow-md shadow-primary">
